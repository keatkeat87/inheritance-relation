export function isEmail(value: string): boolean {
    /*
        undefined || null will return false, but should not pass in undefined and null 啦
        和 c# 一样的验证 https://github.com/Microsoft/referencesource/blob/master/System.ComponentModel.DataAnnotations/DataAnnotations/EmailAddressAttribute.cs
    */
